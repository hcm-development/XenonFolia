...
[![License](https://img.shields.io/github/license/XenonMC/XenonFolia?style=flat-square)](LICENSE.md)
[![Issues](https://img.shields.io/github/issues/XenonMC/XenonFolia?style=flat-square)](https://github.com/XenonMC/XenonFolia/issues)
![Commit Activity](https://img.shields.io/github/commit-activity/w/XenonMC/XenonFolia?style=flat-square)
![GitHub all releases](https://img.shields.io/github/downloads/XenonMC/XenonFolia/total?style=flat-square)
...
## Download
Any versions are available in the [release](https://github.com/XenonMC/XenonFolia/releases), also you can build it by yourself through [the following steps](./README_EN.md#Build).
...
```kotlin
dependencies {
    compileOnly("me.earthme.xenonfolia:xenonfolia-api:1.20.4-R0.1-SNAPSHOT")
}
 ```
For maven
```xml
<dependency>
  <groupId>me.earthme.xenonfolia</groupId>
