...
dependencies {
    // Comment out paperweight dependencies for now
...
paperweight {
    serverProject.set(findProject(":folia-server"))
...
tasks.jar {
    ...
    manifest {
        ...
        val implementationVersion = "$mcVersion-${build ?: "DEV"}"
        attributes(
            "Main-Class" to "org.bukkit.craftbukkit.Main",
            "Implementation-Title" to "Folia", // Folia
            "Implementation-Version" to implementationVersion,
            "Implementation-Vendor" to "XenonFolia Team", // Paper
...
tasks.register<JavaExec>("runServer") {
    group = "paper"
    description = "Spin up a test server from the jar"
